...
import bannerAsset from "@/assets/banner.jpeg";
import blogoAsset from "@/assets/blogo.png";
...
const PRODUCTS: Product[] = [
  { id: "tee-lion",    name: "Lion Tee",           description: "Premium cotton tee with gold lion crest.", price: 1050, image: tshirtBlack, sizes: ["S","M","L","XL"],
    colors: [
  ...
  { id: "polo",        name: "Lion Polo",          description: "Premium piqué polo with gold lion crest.", price: 1250, image: poloBlack, sizes: ["S","M","L","XL"],
    colors: [
  ...
  { id: "hoodie",      name: "Simba Hoodie",       description: "Heavyweight fleece hoodie, embroidered crest.", price: 2550, image: hoodieBlack, sizes: ["S","M","L","XL"],
    colors: [
  ...
  { id: "cap",         name: "Lion Cap",           description: "Structured cap with gold embroidery.", price: 650, image: capBlack,
    colors: [
  ...
  { id: "sticker",     name: "Lion Car Sticker",   description: "Die-cut vinyl sticker — carry the roar.", price: 850, image: carSticker },
  { id: "mug",         name: "Roar Mug",           description: "11oz ceramic mug with gold crest.", price: 800,  image: mugBlack },
  { id: "tote",        name: "Lion Tote",          description: "Heavy canvas tote — carry the roar.", price: 650, image: toteBlack },
];
    ...
    <header className="sticky top-0 z-40 backdrop-blur-md bg-background/80 border-b border-border">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4 h-16">
        <a href="#top" className="flex min-w-0 items-center gap-3">
          <img src="/blogo.png" alt="Simba wa Yuda" className="h-10 w-10 shrink-0 rounded-full object-cover" width={40} height={40} />
  ...
  return (
    <section id="top" className="relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <img src="/banner.jpeg" alt="" className="h-full w-full object-cover opacity-40" />
